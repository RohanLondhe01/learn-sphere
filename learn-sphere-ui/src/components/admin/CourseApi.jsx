...
let courses = [
  {
    ...
    title: "React Basics",
    slug: "react-basics",
    smallDescription: "Introduction to React components, props, and state.",
    description:
  ...
  },
  {
    ...
    smallDescription: "Advanced concepts in modern JavaScript.",
    description:
  ...
  },
  {
    ...
    smallDescription: "Essentials of .NET ecosystem.",
    description:
...
export const createCourse = async (course) => {
  ...
  const newCourse = {
    ...
    slug,
    smallDescription: (course.smallDescription || "").trim(),
